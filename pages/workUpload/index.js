...
export default function workupload() {
    ...
    const handleRecruitmentStartDate = (e) => {setRecruitmentStartDate(e.target.value) }

    const [recruitmentEndDate, setRecruitmentEndDate] = React.useState(dateFormat(new Date));
    const handleRecruitmentEndDate= (e) => { setRecruitmentEndDate(e.target.value) }
   ...
   React.useEffect(() => {
        ...
        let daysBetween = (ed.getTime() - sd.getTime()) / (1000 * 3600 * 24);
        if(daysBetween < 0){
            return;
        }
        let dateArray = new Array(daysBetween).fill({'date': sd, 'time': '00:00', 'occupy': 0, 'register': 0})
            ...
            <Box display="flex" justifyContent="center" alignItems="center" alignSelf="center" width= "md">
                ...
                >   
                    <div style={{display:'flex', flexDirection:'row', justifyContent:'left', maxWidth: "90vw", marginTop: '20px', marginBottom: '20px'}}>
                        <div className={'text-[25px] font-bold font-sans'} style={{display:'flex', justifyContent: 'center', alignItems: 'center', margin: '10px'}}>Title</div>
                        <input className={'text-[25px] font-bold font-sans'} type = "text" style={{border: '1px solid black', borderRadius: '10px', padding: '15px', width:'1000px', maxWidth: "70vw"}}
                            value={title} onChange={handleTitle}/>
                    </div>

                    <div style={{display:'flex', flexDirection:'row', justifyContent:'left', maxWidth: "90vw", marginBottom: '20px'}}>
                        <div className={'text-[25px] font-bold font-sans'} style={{display:'flex', justifyContent: 'center', alignItems: 'center', margin: '10px'}}>Recruitment Period</div>
                        <input className={'text-[25px] font-sans'} type="date" value ={recruitmentStartDate} onChange={handleRecruitmentStartDate}/>
                        <div className={'text-[25px] font-sans'} style={{display:'flex', justifyContent:'center', alignItems: 'center', marginRight: '10px', marginLeft: '10px'}}> ~ </div>
                        <input className={'text-[25px] font-sans'} type="date" value ={recruitmentEndDate} onChange={handleRecruitmentEndDate}/>
                    </div>

                    <div style={{display:'flex', flexDirection:'row', justifyContent:'left', maxWidth: "90vw", marginBottom: '20px'}}>
                        <div className={'text-[25px] font-bold font-sans'} style={{display:'flex', justifyContent: 'center', alignItems: 'center', margin: '10px'}}>Volunteering Period</div>
                    ...
                    <div style={{display:'flex', flexDirection:'row', justifyContent:'left', maxWidth: "90vw", marginTop: '20px', marginBottom: '20px'}}>
                        <div className={'text-[20px] font-bold font-sans'} style={{display:'flex', justifyContent: 'center', alignItems: 'center', margin: '10px'}}>Address</div>
                        <input className={'text-[20px] font-bold font-sans'} type = "text" style={{border: '1px solid black', borderRadius: '10px', padding: '15px', width:'1000px', maxWidth: "65vw"}}
                    ...
                    <div style={{display:'flex', flexDirection:'row', justifyContent:'left', maxWidth: "90vw", marginBottom: '20px'}}>
                        <div className={'text-[25px] font-bold font-sans'} style={{display:'flex', justifyContent: 'center', alignItems: 'center', margin: '10px'}}>Files</div> 
                    ...
                    <div>
                            {applyDay.map((arr, i) => (    
                                <div style={{display:'flex', flexWrap:'wrap', flexDirection:'row', justifyContent:'left'}} onChange = {(event) => handleFormDate(event, i)}>
                                    <input id = "date"  type = "date" value = {dateFormat2(new Date(arr['date']), i)} style={{display:'flex', justifyContent:'center', alignSelf: 'center'}}/> 
                                    <input id = "time" type = "time" value = {arr['time']} style={{display:'flex', justifyContent:'center', alignSelf: 'center'}}/>
                                    <input id = "occupy" type = "number" value = {arr['occupy']}
                                    ...
                                    <div style={{display:'flex', flexDirection:'row', justifyContent:'left', margin: '10px'}}>
                                        ...
                                        <input id = "occupy" type = "number" value = {arr['register']} disabled
                                        style={{display:'flex', justifyContent:'center', alignSelf: 'center', border: '1px solid black', borderRadius: '10px', width: '100px'}}/> 
                                    </div>
                                </div>
                            ))}
