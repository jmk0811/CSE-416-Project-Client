            ...
            <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" alignSelf="center" width= "md">
                ...
                >
                    ...
                    {/* style={{border: '1px solid red'}} */}
                        ...
                        <TextField fullWidth style={{marginTop: '20px'}} InputProps={headingStyle} 
                            value={'Title Title of the volunteer work'}/>

                        <div style={{marginTop: '10px', marginBottom: '10px', fontFamily: "'Noto Sans KR', sans-serif"}}>
                            <Typography>Recruitment: {data[0].RecruitmentStart} ~ {data[0].RecruitmentEnd}</Typography>
                            <Typography>Volunteer Work: {data[0].VolunteeringStart} ~ {data[0].VolunteeringEnd}</Typography> 
                        </div>

                        <TextField fullWidth multiline rows = {14} style={{marginTop: '10px'}} InputProps={bodyStyle} 
